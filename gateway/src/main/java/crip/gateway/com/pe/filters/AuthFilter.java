...
public class AuthFilter implements GatewayFilter {
    ...
    //local
    private static final String AUTH_VALIDATE_URI = "http://ms-auth:3030/auth-server/auth/jwt"; //ese ms-auth debe ser en si lo que esta en el docker, mandar una version corregida
    //build in server
